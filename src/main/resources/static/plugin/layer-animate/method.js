var method={
    msg_layer:function(obj){
        ...
        $("body").append( '<div class="msg-layer-bg"></div><div class="msg-layer showAlert"><h5></h5><div class="msg-con"></div><div class="layer-close">&times;</div><div class="layer-btn"><div class="layer-cancel"></div><div class="layer-commit"></div><div class="layer-commit2"></div></div></div>');
        var _layerBg=$(".msg-layer-bg"),_layer=$(".msg-layer"),_close=$(".layer-close"),_cansel=$(".layer-cancel"),_commit=$(".layer-commit"),_commit2=$(".layer-commit2");
        ...
        if(obj.btn){
            ...
            if(obj.btn[1] && obj.btn[1] != 0){
                _commit.css("display","inline-block");
                _commit.html(obj.btn[1]);
            }
            if(obj.btn[2] && obj.btn[2] != 0){
                _commit2.css("display","inline-block");
                _commit2.html(obj.btn[2]);
            }
        }
    },
    msg_close:function(){
